...
\punkt{Formalia}
  \begin{enumerate}
    ...
    \item\textbf{Tidigare mötens protokoll}
    	% föredra tidigare mötes protokoll, 
    	% är det justerat läggs det till handlingarna
  \end{enumerate}
...
\punkt{Rapporter}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Ekonomisk lägesrapportering}
    	% Be kassören säga hur det står till
    \end{enumerate}
...
%  \end{enumerate}
  ...
  % \includepdf[pages=fromp-top]{./xxx/xx.pdf} %För att kunna inkluder pdf-filer, t.ex proppar, motioner m.m
 % \includepdf[pages=fromp-top, landscape]{./xxx/xx.pdf} %Inkuldera pdf i liggande format
